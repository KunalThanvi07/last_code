...
const String SensorAPIUrl = "http://192.168.1.25/api/v1/sensor";
...
void SetupWiFi()
{
  ...
  WiFi.mode(WIFI_STA);
  // WiFiMulti.addAP("Airtel_9574982169", "air32508");
    WiFiMulti.addAP("Tatiya bichhu", "air32508");
...
void SendSensorDataToServer(float SensorTemp, float SensorHumidity )
{
  ...
  if ((millis() - lastTime) > timerDelay) {
    ...
    if (WiFi.status() == WL_CONNECTED) {
      ...
      String httpRequestData = "{\"username\":\"milind\",\"email_id\":\"Jodhpur\",\"devicename\":\"xyz1234\",\"temperature\":" + String(SensorTemp, 0) + ",\"humidity\":" + String(SensorHumidity, 0) + "}";
